...
@section('hero')
  <h1>Kantor Wilayah Imigrasi Sumatera Utara</h1>
...
<section class="layanan-container">
    ...
    <div class="card-container">
      <div class="card">
        ...
        <p>Permohonan perubahan data nama, tempat tanggal lahir, atau jenis kelamin pada paspor melalui proses BAP (Berita Acara Pemeriksaan).</p>
      </div>

      <div class="card">
        <img src="layanan2.jpg" alt="Paspor Hilang">
        <h3>Paspor Hilang dan Rusak</h3>
        <p>Permohonan penggantian paspor dikarenakan paspor lamanya hilang/rusak melalui proses BAP (Berita Acara Pemeriksaan).</p>
      </div>
  ...
  <section id="news">
    ...
    <div class="news-grid">
      ...
      <div class="news-title">Terbukti Overstay, Satu Keluarga Asing Asal Spanyol Dideportasi Dari Indonesia</div>
